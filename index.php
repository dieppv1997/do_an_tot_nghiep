	      ...
	      <div class="section group">
	      	...
	      	?>
				<div class="grid_1_of_4 images_1_of_4">
				     ...
				     <div class="button"><span><a href="details.php?proid=<?php echo $result['productId'] ?>" class="details">Xem thêm</a></span></div>
				</div>
				<?php
						}	
					}
			...
			<?php
	      	...
	      	?>
				...
				<div class="grid_1_of_4 images_1_of_4">
				     ...
				     <div class="button"><span><a href="details.php?proid=<?php echo $result_new['productId'] ?>" class="details">Xem thêm</a></span></div>
				</div>
			<?php
						}	
					}
